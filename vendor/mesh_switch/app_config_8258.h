...
#define HCI_ACCESS		HCI_USE_UART //HCI_USE_NONE RD_EDIT: UART Config Enable

#if (HCI_ACCESS==HCI_USE_UART)
#define UART_TX_PIN		UART_TX_PD7 //UART_TX_PB1   RD_EDIT: UART Config TX Pin
#define UART_RX_PIN		UART_RX_PA0 //UART_RX_PB0   RD_EDIT: UART Config Rx Pin
#endif
...
#define  KB_BUTTON_PIN	{GPIO_PB4, GPIO_PB5, GPIO_PB6, GPIO_PB7, GPIO_PC0, GPIO_PC1}
